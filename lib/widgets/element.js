...
/*
  ...
  to implement a 'positionParent' option. (element.options.positionParent)
    ...
    The painter's algorithm is fine in most cases, but sometimes you need to do things differently.
    ...
    For example, imagine a tmux / multiplex setup, where you need a popup to appear a particular window.
    In terms of draw order, this element should be a child of screen or a top level element, but

...
const { hexToRGB, RGBToHex, ccolors, ncolors, colorNames } = require('./old');
...
/*
    Notes:
        ...
        - the color conversion code from https://github.com/robey/antsy is more accurate and less janky than blessed's, which was simply
          incorrect some of the time. Unfortunately https://github.com/robey/antsy seems to no longer be available. The

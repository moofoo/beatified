...
/*
    Beatified additions/mods:

    - double and triple clicking
    - mouse dragging
    - 'deadcell' detection (should double check this)
    ...
    Regarding mouse dragging:
        ...
        FIXME - Widget compatability check related to mousedown to mousemove change
*/

Program.prototype._bindMouse = function (s, buf, stream = null) {
  ...
  switch (param) {
    ...
    default:
      ...
      if (m) {
        ...
        //FIXME - why did I comment this out?
